...
def fetch_posts():
    ...
    # Ищем блоки сообщений в веб-версии ТГ
    ...
    for msg in messages:
        ...
        if text_el:
            text = text_el.decode_contents() # Сохраняем переносы строк и ссылки
...
"""
    if not posts:
        html += '<div class="news-card"><div class="news-text">Нет постов</div></div>'
